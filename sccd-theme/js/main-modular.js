  ...
  if (page === 'index') {
    ...
    if (document.body.classList.contains('page-coming-soon')) {
      ...
      const replaceMobileMenuWithCreate = () => {
        ...
        wrap.innerHTML = '<a href="pages/create.html" class="w-full h-full flex items-center justify-center" style="text-decoration:none;color:currentColor;font-weight:700;font-size:1.125rem;letter-spacing:0.02em;white-space:nowrap">CREATE!</a>';
